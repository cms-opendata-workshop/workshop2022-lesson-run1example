...
void dimuonSpectrum2012_local() {
    // Enable multi-threading
    // The default here is set to a single thread. You can choose the number of threads based on your system.
    ROOT::EnableImplicitMT();

    // Create dataframe from NanoAOD files
    // replace the follwing by your own local file paths
    ROOT::RDataFrame df("Events", {"/nfs/dust/cms/user/yangq2/eosdata/Run2012B_DoubleMuParked_merged.root", "/nfs/dust/cms/user/yangq2/eosdata/Run2012C_DoubleMuParked_merged.root"});
    ...
    // Save plot
    c->SaveAs("dimuonSpectrum2012_C_local.pdf");
