...
// To run it as a script, start interactive root and type .x Dimuon2011.C
// (takes about 10 minutes locally from interactive DESY workgroup server
//  when run repeatedly; about twice the first time)
//
// enable implicit multithreading
// ROOT::EnableImplicitMT();
//
// chain t1 is 2011 DoubleMu Run A in NanoAODRun1 format
// should use merged ntuples for trigger selection!
TChain *t1 = new TChain("Events");
//t1->Add("/pnfs/desy.de/cms/tier2/store/user/geiser/Data2011/nanoAODplus_v1/DoubleMu/Run2011A_DoubleMu_AOD_12Oct2013-v1.root");
t1->Add("/nfs/dust/cms/user/geiser/eosdata/Run2011A_DoubleMu_merged.root");
...
//t2->Add("/nfs/dust/cms/user/yangq2/NanoAODplus_v1/output/data/2011/MuOnia/RunA/00000.root");
//t2->Add("/nfs/dust/cms/user/yangq2/NanoAODplus_v1/output/data/2011/MuOnia/RunA/00001.root");
//t2->Add("/nfs/dust/cms/user/yangq2/NanoAODplus_v1/output/data/2011/MuOnia/RunA/20000.root");
//t2->Add("/nfs/dust/cms/user/yangq2/NanoAODplus_v1/output/data/2011/MuOnia/RunA/210000.root");
t2->Add("/nfs/dust/cms/user/yangq2/eosdata/Run2011A_MuOnia_merged.root");
...
// try to use Root THStack option? 
// regenerate ticks 
gPad->RedrawAxis();
//
// produce output picture file 
c1->Print("Dimuon2011_local.png");
// write out histograms (will delete previous file, if any!)
TFile Dimuon2011("Dimuon2011_local.root","RECREATE"); 
h_dimulog1->Write();
h_dimulog2->Write();
h_dimulog3->Write();
h_dimulog4->Write();
