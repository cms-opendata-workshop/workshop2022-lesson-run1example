...
# replace the following by your appropriate own local paths  
df = ROOT.RDataFrame("Events", {"/nfs/dust/cms/user/yangq2/eosdata/Run2012B_DoubleMuParked_merged.root", "/nfs/dust/cms/user/yangq2/eosdata/Run2012C_DoubleMuParked_merged.root"})
...
# Save plot
c.SaveAs("dimuonSpectrum2012_py_local.pdf")
